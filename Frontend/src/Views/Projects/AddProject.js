                ...
                <Modal isOpen={this.props.modal} toggle={() => this.props.toggle()} className='modal-popup' scrollable>
                    ...
                    <ModalBody className="modal-body">
                        <form>
                            ...
                            <div className="form-group">
                                <h4 className="font-weight-bold" >Skills: </h4><br />
                                <input onChange={this.props.handleSkillChange} name='skills' className='form-control' type='text' required></input><br /><br />
                            </div>
                            <div className="form-group">
