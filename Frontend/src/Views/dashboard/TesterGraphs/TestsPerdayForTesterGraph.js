...
class TestsPerDayTesterGraph extends Component {
    constructor(props) {
        super(props);
        this.state = {
            defaultImg: false,
    ...
    componentDidMount() {
        ...
        let url = 'http://'+hostaddress+':3001/tester/stats/testsPerdayForTester';
        let token = localStorage.getItem('jwtToken');
        //console.log(token);
        axios("/tester/stats/testsPerdayForTester",{
            method: 'get',
            //url: url,
            params: { "id": testerid },     
...
export default TestsPerDayTesterGraph;